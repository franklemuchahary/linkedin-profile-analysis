...
3. Soft skills like leadership and management are quite important for both Chief Technology Officers and Consultants. People in senior technical roles looking to become CTOs in the future should not focus entirely on technical skills and work on obtaining these soft skills too
4. Ph.D.  or at least a Master's Degree seems to be quite popular among Principal Data Scientists. An MBA is the best bet to get into the consulting world. For, CTOs, the level of education makes less of a difference and experience is what matters more than the level of education.
